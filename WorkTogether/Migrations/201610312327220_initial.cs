    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.WorkWeeks", t => t.WorkWeek_Id)
                .Index(t => t.WorkWeek_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.WorkDays", "WorkWeek_Id", "dbo.WorkWeeks");
            DropForeignKey("dbo.WorkWeeks", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropIndex("dbo.WorkDays", new[] { "WorkWeek_Id" });
